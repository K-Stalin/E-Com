                  ...
                  return (
                    ...
                    >
                      <div className="flex  items-start gap-6">
                        ...
                        <p className="text-sm sm:text-lg font-medium-700">
                          {productData.name}
                        </p>
    ...
    <div className='flex justify-end my-20'>
            <div className='w-full  sm:w-[450px]'>
                ...
                <div className='w-full text-end'>
                       <button onClick={()=>navigate("/place-order")} className='bg-black text-white text-sm my-8 px-8 py-4'>PROCEED TO CHECKOUT</button>  
                </div>
            </div>
    </div>
  </div>
